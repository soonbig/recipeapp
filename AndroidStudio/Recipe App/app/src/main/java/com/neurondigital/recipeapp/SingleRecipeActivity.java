...
public class SingleRecipeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout.LayoutParams localObject = new LinearLayout.LayoutParams(mScreenWidth, (int) (Configurations.RECIPE_IMAGE_RATIO * mScreenWidth));
        ...
        favoriteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (recipe.isFavorite(context)) {
                    favoriteBtn.setIcon(new IconicsDrawable(context, FontAwesome.Icon.faw_star_o).colorRes(R.color.accent));
                    recipe.setFavorite(context, false);
                } else {
                    favoriteBtn.setIcon(new IconicsDrawable(context, FontAwesome.Icon.faw_star).colorRes(R.color.accent));
